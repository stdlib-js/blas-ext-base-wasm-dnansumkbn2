...
interface ModuleConstructor {
	...
	*
	* // Create a BLAS routine:
	* var mod = dnansumkbn2.Module( mem );
	* // returns <Module>
	*
	* // Initialize the routine:
	* mod.initializeSync();
...
/**
* Interface describing a `dnansumkbn2` WebAssembly module.
*/
...
/**
* Interface describing `dnansumkbn2`.
*/
interface Routine extends ModuleWrapper {
	...
	*
	* var out = dnansumkbn2.main( 4, x, 1 );
	* // returns 1.0
	*/
	...
	*
	* var out = dnansumkbn2.ndarray( 4, x, 2, 1 );
	* // returns 7.0
	*/
...
* // returns 7.0
*/
declare var dnansumkbn2: Routine;
