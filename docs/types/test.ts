...
import dnansumkbn2 = require( './index' );
...
// Attached to the main export is a `main` method which returns a number...
{
	...
	dnansumkbn2.main( x.length, x, 1 ); // $ExpectType number
}
...
// The compiler throws an error if the `main` method is provided a first argument which is not a number...
{
	...
	dnansumkbn2.main( '10', x, 1 ); // $ExpectError
	dnansumkbn2.main( true, x, 1 ); // $ExpectError
	dnansumkbn2.main( false, x, 1 ); // $ExpectError
	dnansumkbn2.main( null, x, 1 ); // $ExpectError
	dnansumkbn2.main( undefined, x, 1 ); // $ExpectError
	dnansumkbn2.main( [], x, 1 ); // $ExpectError
	dnansumkbn2.main( {}, x, 1 ); // $ExpectError
	dnansumkbn2.main( ( x: number ): number => x, x, 1 ); // $ExpectError
}
...
// The compiler throws an error if the `main` method is provided a second argument which is not a Float64Array...
{
	...
	dnansumkbn2.main( x.length, '10', 1 ); // $ExpectError
	dnansumkbn2.main( x.length, true, 1 ); // $ExpectError
	dnansumkbn2.main( x.length, false, 1 ); // $ExpectError
	dnansumkbn2.main( x.length, null, 1 ); // $ExpectError
	dnansumkbn2.main( x.length, undefined, 1 ); // $ExpectError
	dnansumkbn2.main( x.length, [], 1 ); // $ExpectError
	dnansumkbn2.main( x.length, {}, 1 ); // $ExpectError
	dnansumkbn2.main( x.length, ( x: number ): number => x, 1 ); // $ExpectError
}
...
// The compiler throws an error if the `main` method is provided a third argument which is not a number...
{
	...
	dnansumkbn2.main( x.length, x, '10' ); // $ExpectError
	dnansumkbn2.main( x.length, x, true ); // $ExpectError
	dnansumkbn2.main( x.length, x, false ); // $ExpectError
	dnansumkbn2.main( x.length, x, null ); // $ExpectError
	dnansumkbn2.main( x.length, x, undefined ); // $ExpectError
	dnansumkbn2.main( x.length, x, [] ); // $ExpectError
	dnansumkbn2.main( x.length, x, {} ); // $ExpectError
	dnansumkbn2.main( x.length, x, ( x: number ): number => x ); // $ExpectError
}
...
// The compiler throws an error if the `main` method is provided an unsupported number of arguments...
{
	...
	dnansumkbn2.main(); // $ExpectError
	dnansumkbn2.main( x.length ); // $ExpectError
	dnansumkbn2.main( x.length, x ); // $ExpectError
	dnansumkbn2.main( x.length, x, 1, 10, 2 ); // $ExpectError
}
...
// Attached to main export is an `ndarray` method which returns a number...
{
	...
	dnansumkbn2.ndarray( x.length, x, 1, 0 ); // $ExpectType number
}
...
// The compiler throws an error if the `ndarray` method is provided a first argument which is not a number...
{
	...
	dnansumkbn2.ndarray( '10', x, 1, 0 ); // $ExpectError
	dnansumkbn2.ndarray( true, x, 1, 0 ); // $ExpectError
	dnansumkbn2.ndarray( false, x, 1, 0 ); // $ExpectError
	dnansumkbn2.ndarray( null, x, 1, 0 ); // $ExpectError
	dnansumkbn2.ndarray( undefined, x, 1, 0 ); // $ExpectError
	dnansumkbn2.ndarray( [], x, 1, 0 ); // $ExpectError
	dnansumkbn2.ndarray( {}, x, 1, 0 ); // $ExpectError
	dnansumkbn2.ndarray( ( x: number ): number => x, x, 1, 0 ); // $ExpectError
}
...
// The compiler throws an error if the `ndarray` method is provided a second argument which is not a Float64Array...
{
	...
	dnansumkbn2.ndarray( x.length, '10', 1, 0 ); // $ExpectError
	dnansumkbn2.ndarray( x.length, true, 1, 0 ); // $ExpectError
	dnansumkbn2.ndarray( x.length, false, 1, 0 ); // $ExpectError
	dnansumkbn2.ndarray( x.length, null, 1, 0 ); // $ExpectError
	dnansumkbn2.ndarray( x.length, undefined, 1, 0 ); // $ExpectError
	dnansumkbn2.ndarray( x.length, [], 1, 0 ); // $ExpectError
	dnansumkbn2.ndarray( x.length, {}, 1, 0 ); // $ExpectError
	dnansumkbn2.ndarray( x.length, ( x: number ): number => x, 1, 0 ); // $ExpectError
}
...
// The compiler throws an error if the `ndarray` method is provided a third argument which is not a number...
{
	...
	dnansumkbn2.ndarray( x.length, x, '10', 0 ); // $ExpectError
	dnansumkbn2.ndarray( x.length, x, true, 0 ); // $ExpectError
	dnansumkbn2.ndarray( x.length, x, false, 0 ); // $ExpectError
	dnansumkbn2.ndarray( x.length, x, null, 0 ); // $ExpectError
	dnansumkbn2.ndarray( x.length, x, undefined, 0 ); // $ExpectError
	dnansumkbn2.ndarray( x.length, x, [], 0 ); // $ExpectError
	dnansumkbn2.ndarray( x.length, x, {}, 0 ); // $ExpectError
	dnansumkbn2.ndarray( x.length, x, ( x: number ): number => x, 0 ); // $ExpectError
}
...
// The compiler throws an error if the `ndarray` method is provided a fourth argument which is not a number...
{
	...
	dnansumkbn2.ndarray( x.length, x, 1, '10' ); // $ExpectError
	dnansumkbn2.ndarray( x.length, x, 1, true ); // $ExpectError
	dnansumkbn2.ndarray( x.length, x, 1, false ); // $ExpectError
	dnansumkbn2.ndarray( x.length, x, 1, null ); // $ExpectError
	dnansumkbn2.ndarray( x.length, x, 1, undefined ); // $ExpectError
	dnansumkbn2.ndarray( x.length, x, 1, [] ); // $ExpectError
	dnansumkbn2.ndarray( x.length, x, 1, {} ); // $ExpectError
	dnansumkbn2.ndarray( x.length, x, 1, ( x: number ): number => x ); // $ExpectError
}
...
// The compiler throws an error if the `ndarray` method is provided an unsupported number of arguments...
{
	...
	dnansumkbn2.ndarray(); // $ExpectError
	dnansumkbn2.ndarray( x.length ); // $ExpectError
	dnansumkbn2.ndarray( x.length, x ); // $ExpectError
	dnansumkbn2.ndarray( x.length, x, 1 ); // $ExpectError
	dnansumkbn2.ndarray( x.length, x, 1, 0, 10, 2 ); // $ExpectError
}
...
// Attached to the main export is a `Module` constructor which returns a module...
{
	...
	dnansumkbn2.Module( mem ); // $ExpectType Module
}

// The compiler throws an error if the `Module` constructor is not provided a WebAssembly memory instance...
{
	dnansumkbn2.Module( '10' ); // $ExpectError
	dnansumkbn2.Module( true ); // $ExpectError
	dnansumkbn2.Module( false ); // $ExpectError
	dnansumkbn2.Module( null ); // $ExpectError
	dnansumkbn2.Module( undefined ); // $ExpectError
	dnansumkbn2.Module( [] ); // $ExpectError
	dnansumkbn2.Module( {} ); // $ExpectError
	dnansumkbn2.Module( ( x: number ): number => x ); // $ExpectError
}
...
// The `Module` constructor returns a module instance having a `main` method which returns a number...
{
	...
	const mod = dnansumkbn2.Module( mem );
...
// The compiler throws an error if the `ndarray` method of a module instance is provided a second argument which is not a number...
{
	...
	mod.ndarray( 5.0, '10', 0, 1 ); // $ExpectError
	mod.ndarray( 5.0, true, 0, 1 ); // $ExpectError
	mod.ndarray( 5.0, false, 0, 1 ); // $ExpectError
	mod.ndarray( 5.0, null, 0, 1 ); // $ExpectError
	mod.ndarray( 5.0, undefined, 0, 1 ); // $ExpectError
	mod.ndarray( 5.0, [], 0, 1 ); // $ExpectError
	mod.ndarray( 5.0, {}, 0, 1 ); // $ExpectError
	mod.ndarray( 5.0, ( x: number ): number => x, 0, 1 ); // $ExpectError
}
