...
*
* // Perform operation:
* var sum = dnansumkbn2.main( 4, x, 1 );
* // returns 1.0
*
* @example
* var Float64Array = require( '@stdlib/array-float64' );
...
*
* // Perform operation:
* var sum = dnansumkbn2.ndarray( 4, x, 2, 1 );
* // returns 7.0
*/
function Routine() {
...
* // returns 1.0
*/
setReadOnly( Routine.prototype, 'main', function dnansumkbn2( N, x, strideX ) {
...
* // returns 7.0
*/
setReadOnly( Routine.prototype, 'ndarray', function dnansumkbn2( N, x, strideX, offsetX ) {
	var ptrs;
	var p0;
